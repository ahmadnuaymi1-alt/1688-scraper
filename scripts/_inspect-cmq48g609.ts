/**
 * Inspect cmq48g609000jw2oo2ubz3vrm (watch) — variants, images, productType, description.
 * Read-only.
 */
...
(async () => {
  ...
  try {
    ...
    for (const v of variants) {
      ...
      if (v.featuredImage) console.log(`        featImgUrl: ${pubUrl(v.featuredImage.storagePath, v.featuredImage.sourceUrl)}`);
    }
