/**
 * Phase 0a critic prototype: score each freshly-generated hero on
 * cmq3nwk6g000jw2hst5cwxfj8 against the seed category-watches.md rubric.
 * Read-only — does NOT mutate heroes; just reports.
 */
...
(async () => {
  ...
  const out = path.resolve(process.cwd(), ".tmp-classify", `critic-prototype-${PID}.json`);
