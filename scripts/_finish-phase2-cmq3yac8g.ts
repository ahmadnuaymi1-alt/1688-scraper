/**
 * Finish Phase 2 (handleRulesJob) for job cmq3yac8g0001w25gcap6v1la
 * (productId cmq3ybrqm000jw25g2h0dyzbp) — agent-mode batch 2026-06-07.
 */
...
const JOB_IDS = ["cmq3yac8g0001w25gcap6v1la"];
